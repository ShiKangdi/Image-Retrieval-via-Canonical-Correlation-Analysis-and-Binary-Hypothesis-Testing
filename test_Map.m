...
Folder = '' % Place Your Folder address in here. The folder stores the results in txt format. The subfolders'names are "Max512", "Max450".... The name of each .txt file in the subfolder is "query0.txt","query1.txt","query2.txt"....
